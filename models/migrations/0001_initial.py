# Generated by Django 3.2 on 2021-09-22 18:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='members_projects', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': '_project',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('TODO', 'TODO'), ('IN_PROCESS', 'IN_PROCESS'), ('COMPLETED', 'COMPLETED')], max_length=64)),
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='models.project')),
            ],
            options={
                'db_table': '_task',
            },
